...
#include "gp_planner/benchmark/TDR_OBCA/log.h"
...
DistanceApproachIPOPTRelaxEndInterface::DistanceApproachIPOPTRelaxEndInterface(
  ...
  max_steer_angle_ = BenchmarkVehicleConfig::max_steer_angle /
                     BenchmarkVehicleConfig::steer_ratio;
  ...
  max_steer_rate_ = BenchmarkVehicleConfig::max_steer_angle_rate /
                    BenchmarkVehicleConfig::steer_ratio;
  use_fix_time_ = distance_approach_config_.use_fix_time();
  wheelbase_ = BenchmarkVehicleConfig::wheelbase;
