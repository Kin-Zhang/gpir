...
using apollo::common::math::common::math::Vec2d;
 ...
 public:
  ...
  bool VPresentationObstacle(
    ...
    for (size_t i = 0; i < obstacles_num_; i++) {
      std::vector<common::math::Vec2d> vertices_cw;
...
//                        ObstacleContainer* obstacles_ptr, double* x, double*
//                        y, double* phi, double* v, double* a, double* steer,
//                        double* opt_x, double* opt_y, double* opt_phi,
//                        double* opt_v, double* opt_a, double* opt_steer,
//                        double* opt_time, double* opt_dual_l, double*
//                        opt_dual_n, size_t* output_size, double* hybrid_time,
//                        double* dual_time, double* ipopt_time) {
