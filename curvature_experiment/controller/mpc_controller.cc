...
#include "curvature_experiment/controller/lmpc_osqp_solver.h"
...
bool MpcController::CalculateAckermannDrive(
  ...
  auto ref_state = trajectory.GetInterpolatedNearestState(predict_pos);
  auto preview_state = ref_state;
  ...
  control_cmd->vel = optimal_speed;
  control_cmd->steer = optimal_steer;
