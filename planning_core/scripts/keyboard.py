        ...
        for event in pg.event.get():
            if event.type == pg.KEYDOWN:
                ...
                if event.key == pg.K_w:
                    ...
                    # actor2 = self.agent_generator.spawn_agent_at("back_left", 1)
                    # self.agent_generator.set_speed_percentage_difference(actor2, 30.0)
                    actor2 = self.agent_generator.spawn_agent_at("back_right", 1)
                    self.agent_generator.set_speed_percentage_difference(actor2, -30.0)
                    actor1 = self.agent_generator.spawn_agent_at("front", 20)
                    self.agent_generator.set_speed_percentage_difference(actor1, -50.0)
                    actor1 = self.agent_generator.spawn_agent_at("front", 150)
                    self.agent_generator.set_speed_percentage_difference(actor1, 0.0)
                    actor1 = self.agent_generator.spawn_agent_at("front_left", 50)
                    self.agent_generator.set_speed_percentage_difference(actor1, -50.0)
                    # actor1 = self.agent_generator.spawn_agent_at("front_right", 50)
                    # self.agent_generator.set_speed_percentage_difference(actor1, -30.0)

                    actor1 = self.agent_generator.spawn_agent_at("back_left", -20)
                    self.agent_generator.set_speed_percentage_difference(actor1, -50.0)
                    # actor1 = self.agent_generator.spawn_agent_at("front_right", 100)
                    # self.agent_generator.set_speed_percentage_difference(actor1, -10.0)

                    # actor3 = self.agent_generator.spawn_agent_at("back_left", -5)
                    # actor4 = self.agent_generator.spawn_agent_at("front_right", 5)
                    # actor5 = self.agent_generator.spawn_agent_at("back_right", -15)
